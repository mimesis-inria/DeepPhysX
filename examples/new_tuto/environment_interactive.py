...
class SpringEnvironment(BaseEnvironment):
    ...
    def __init__(self,
        ...
        self.plt.add_callback('timer', self.time_step)
    ...
    async def step(self):
        ...
        self.set_training_data(input=zeros(8), ground_truth=zeros(2))
    ...
    def time_step(self, _):
        ...
        if self.animate:
            ...
            self.X_net[[0, 2]] = prediction['prediction'][0]
            self.V_net[[0, 2]] = prediction['prediction'][1]
    ...
    def render(self):
        ...
        self.mesh_spring.stretch(q1=[0., 0.5 * self.cube_size, 0.], q2=self.X_net)
    ...
    def slider_x(self, *args):
        ...
        if not self.animate:
            ...
            self.X_net[0] = self.slider_x.value
    ...
    def slider_z(self, *args):
        ...
        if not self.animate:
            ...
            self.X_net[2] = -self.slider_z.value
...
if __name__ == '__main__':
    ...
    network_config = FCConfig(dim_layers=[8, 10, 4],
                              dim_output=2)
