...
def create_runner(visualizer=False):
    ...
    # Environment config
    environment_config = SofaEnvironmentConfig(environment_class=ArmadilloPrediction,
    ...
    net_config = FCConfig(dim_output=3,
    ...
    # Runner
    if visualizer:
        return BasePrediction(network_config=net_config,
